...
<body>
  ...
  <section class="dashboard_main">
    ...
    <div class="content">
      ...
      <div class="right_help_body">
        <p>You can ask us for any help/query by just filling this form.</p>
        <div class="form">
          <form action="">
            ...
            <div>
              <div class="name">
                ...
                <input type="text" name="name" id="name" placeholder="Enter your Complete Name"/>
              </div>
            ...
            <div class="query">
              ...
              <textarea name="message" id="message" cols="30" rows="10" placeholder="You can write you Message/Query here"></textarea>
            </div>

            <button type="button">Submit Your Query</button>
