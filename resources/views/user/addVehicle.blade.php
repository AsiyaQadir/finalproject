...
<body>
  ...
  <section class="dashboard_main">
    ...
    <div class="content">
      ...
      <div class="right_add_vehical_body">
        <div class="form">
          <form action="">

              <div class="name">
                <label for="car_name">Car Name:</label><br>
                <input type="text" name="car_name" id="car_name" placeholder="Enter your Car Name">
              </div>

              <div class="model">
                <label for="car_model">Car Model:</label><br>
                <input type="text" name="car_model" id="car_model" placeholder="Enter your Car Model">
              </div>

              <div class="power">
                <label for="car_power">Car Power( CC ):</label>
                <input type="text" name="car_power" id="car_power" placeholder="Enter you Car Power ( CC )">
              </div>

              <div class="number">
                <label for="car_number">Car Number:</label>
                <input type="text" name="car_number" id="car_number" placeholder="Enter you Car Number">
              </div>

              <button type="button">Save Car</button>
          </form>
        </div>
