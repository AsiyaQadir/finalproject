...
<body>
  ...
  <section class="dashboard_main">
    ...
    <div class="content">
      ...
      <div class="right_booking_body">
        <div class="cards">

          <div>
            <div class="card">
              <div class="card_head">
                <h4>Mehran Tip Sensor Cleaning</h4>
                <a href="viewPendingBooking.html">View</a>
              </div>
              <div class="card_body">
                <table>
                  <tr>
          ...
          <div>
            <div class="card">
              <div class="card_head">
                <h4>Mehran Teppet Adjustment</h4>
                <a href="viewCompleteBooking.html">View</a>
              </div>
              <div class="card_body">
                <table>
                  <tr>
