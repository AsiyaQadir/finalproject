        ...
        <div class="form">
          <form action="">
            ...
            <div class="buttons">
              ...
              <button type="button" onclick="window.location.replace('addVehical.html')"><i class="fas fa-car"></i> Add Vehical</button>
            </div>
          </form>
        </div>
        <div class="carsList">
          <ul>
            <li><a href="#">Mehran VXR</a></li>
            <li><a href="#">Honda Suzuki</a></li>
            <li><a href="#">Audi</a></li>
          </ul>
        </div>
      </div>
